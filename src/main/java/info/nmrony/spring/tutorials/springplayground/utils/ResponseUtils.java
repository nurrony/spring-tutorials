...
final public class ResponseUtils {
  ...
  final public static <T> SuccessResponse.WithResource<T> buildResourceResponse(Collection<T> data, String message, int statusCode) {

    return (WithResource<T>) SuccessResponse.WithResource()
  ...
  @SuppressWarnings("unchecked")
  final public static <T> SuccessResponse.WithResource<T> buildResourceResponse(T data, String message, int statusCode) {
    return (WithResource<T>) SuccessResponse.WithResource()
      .statusCode(statusCode)
      .message(message)
      .data(data)
  ...
  @SuppressWarnings("unchecked")
  final public static <T> SuccessResponse.WithPaginatedResourceCollection<T> buildPaginatedResponse(Page<T>page, String message, int statusCode) {
